...
CommentThread.remove().exec(function(){
  Photo.remove().exec(function(){
    Page.remove().exec(function(){
      ...
      addPhoto('Zombie1', 'Zombie1.jpg');
      addPhoto('Zombie2', 'Zombie2.jpg');
      addPhoto('Zombie3', 'Zombie3.jpg');  
      addPhoto('Zombie4', 'Zombie4.jpg');   
      addPhoto('Zombie5', 'Zombie5.jpg');   
      addPhoto('Zombie6', 'Zombie6.jpg');      
    });
  });
});;